...
import com.joshhendo.numbersearch.views.ViewBusinessList;
 ...
 * Time: 7:42 PM
 */
public class SearchBusiness extends SearchScreen
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        name = (EditText) findViewById(R.id.business_edit_business_name);
        location = (AutoCompleteTextView) findViewById(R.id.business_edit_location);

        // Set Get current location button
        currentlocation = (ImageButton) findViewById(R.id.business_button_location);
        setGetCurrentLocation(currentlocation, location, this);

        // Search button
        Button search = (Button) findViewById(R.id.business_button_search);
        search.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View view)
            {
                ...
                Intent intent = new Intent(SearchBusiness.this, ViewBusinessList.class);
